    ...
    return (
      <nav className="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div className="collapse navbar-collapse" id="navbarTogglerDemo01">
          ...
          <Button startIcon={<BusinessIcon />} variant='contained' disableTouchRipple size='medium' color='secondary' style={{ marginRight: 5 }}>{this.state.currentEmpresaName}</Button>
          <Link to={{
            pathname: "/minhaConta",
            state: {
              idUser: this.props.idUser,
